...
export const Navbar = () => {
  ...
  return (
    <NextUINavbar
      ...
      className="relative mx-auto mt-[35px] flex h-[32px] w-full max-w-[1170px] items-center justify-start overflow-visible rounded-[17.5px] bg-darkHome px-[25px] text-base sm:w-[calc(100%-50px)] sm:px-[25px]"
    >
      <NavbarContent
      ...
      {isMenuOpen && (
        <NavbarMenu className="absolute right-0 top-0 mt-[50px] bg-white p-4 shadow-md">
